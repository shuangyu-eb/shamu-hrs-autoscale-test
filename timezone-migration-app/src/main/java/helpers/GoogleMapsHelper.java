...
public class GoogleMapsHelper {
    ...
    public String findTimezone(final TimezoneAddress timezoneAddress) throws Exception {
    ...
    private String findTimezoneByZipCode(final String postalCode) {
        try {
            ...
            log.warn("Error in Zipcode Timezone, going to city/state");
            return null;
        }
    }

    private String findTimezoneByCityState(final String city, final String state) throws Exception {
    ...
    private String findTimezoneByState(final String state) throws Exception {
